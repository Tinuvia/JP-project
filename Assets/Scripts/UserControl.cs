...
public class UserControl : MonoBehaviour
{
    ...
    {
        // Handles everything when the player left-clicks (selecting one of the forklifts)
    ...
    {
        //Handles everything when the player right-clicks (giving orders to the forklift)
        var ray = GameCamera.ScreenPointToRay(Input.mousePosition);
        RaycastHit hit;
        if (Physics.Raycast(ray, out hit))
        {
